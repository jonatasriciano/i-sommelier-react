          ...
          <Grid container spacing={3}>
            <Grid item xs={12} lg={4}>
              <FilledInfoCard
                ...
                action={{
                  type: "external",
                  route: "https://github.com/jonatasricianolearning-lab/react/overview/material-kit/",
                  label: "Let's start",
                }}
              />
            </Grid>
            <Grid item xs={12} lg={4}>
              <FilledInfoCard
                ...
                action={{
                  type: "external",
                  route: "https://github.com/jonatasricianolearning-lab/react/overview/datepicker/",
                  label: "Read more",
                }}
              />
            </Grid>
            <Grid item xs={12} lg={4}>
              <FilledInfoCard
                ...
                action={{
                  type: "external",
                  route: "https://github.com/jonatasricianolearning-lab/react/alerts/material-kit/",
                  label: "Read more",
                }}
              />
            </Grid>
