        ...
        <Container sx={{ position: "relative", zIndex: 2, py: 12 }}>
          <Grid container item xs={12} md={7} justifyContent="center" mx="auto" textAlign="center">
            ...
            <MKTypography variant="body2" color="white" mb={6}>
              ...
              Jonatas Silveira where you can find the Design System in HTML. Start a new project or give
            ...
            <MKButton
              ...
              size="large"
              component="a"
              href="https://github.com/jonatasriciano/i-sommelier-react"
              sx={{ mb: 2 }}
            >
              Download Now
            </MKButton>
            ...
            <Grid container spacing={3} justifyContent="center">
              <Grid item xs={4} lg={2}>
                <Tooltip title="Bootstrap 5 - Most popular front-end component library">
                  <MKBox
                    component="a"
                    href="https://github.com/jonatasricianoproduct/material-kit"
                    target="_blank"
                  >
                    <MKBox
                      component="img"
